...
| <a name="input_service_role_name"></a> [service\_role\_name](#input\_service\_role\_name) | Service role name of existing IAM role to attach to Beanstalk deployment | `string` | `""` | no |
