...
|------|-------------|------|---------|:--------:|
| <a name="input_accesslogs_s3_enabled"></a> [accesslogs\_s3\_enabled](#input\_accesslogs\_s3\_enabled) | Set access logs s3 in case of application load balancer and don't in case of shared load balancer | `string` | `"true"` | no |
