...
| <a name="input_existing_instance_role_name"></a> [existing\_instance\_role\_name](#input\_existing\_instance\_role\_name) | Instance role name of existing IAM role to attach to Beanstalk deployment | `string` | `""` | no |
| <a name="input_existing_service_role_name"></a> [existing\_service\_role\_name](#input\_existing\_service\_role\_name) | Service role name of existing IAM role to attach to Beanstalk deployment | `string` | `""` | no |
